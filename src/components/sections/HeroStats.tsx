...
export function HeroStats() {
  ...
  return (
    <div className="w-full max-w-[240px] ml-auto">
      <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] overflow-hidden divide-y divide-white/5 shadow-2xl">
        {STATS_DATA.map((stat, idx) => (
          <div key={idx} className="p-5 group hover:bg-white/5 transition-colors">
            <h4 className="text-2xl lg:text-3xl font-black text-accent mb-0.5 tracking-tighter">
