    ...
    <div className="flex flex-col gap-0">
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-foreground">
        ...
        <div className="container relative z-10 px-4 py-20">
          <div className="max-w-3xl flex flex-col gap-6">
            <Badge variant="outline" className="w-fit text-accent border-accent px-4 py-1 text-sm bg-accent/10">
      ...
      <section className="py-12 bg-secondary/30 border-y">
        <div className="container px-4">
          <p className="text-center text-xs font-bold uppercase tracking-widest text-muted-foreground mb-8">Trusted by leading organizations</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60">
            {/* Mock client logos */}
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="text-foreground font-black text-xl italic grayscale">
                CLIENT_{i}
              </div>
            ))}
          </div>
