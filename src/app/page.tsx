          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            <div className="lg:col-span-8 flex flex-col gap-6 text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 mt-2">
                <Button size="lg" className="liquid-btn liquid-btn--solid bg-accent hover:bg-accent/90 text-foreground font-black rounded-xl px-8 h-12 text-sm" asChild>
                  <Link href="/projects">See Our Work <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
                <Button size="lg" variant="outline" className="liquid-btn liquid-btn--ghost text-white border-white/60 hover:bg-white/10 rounded-xl px-8 h-12 text-sm font-bold" asChild>
